...
The packages in the `ament_index` repository were released into the `bouncy` distro by running `/usr/bin/bloom-release ament_index -r bouncy -t bouncy` on `Mon, 18 Jun 2018 11:54:20 -0000`
